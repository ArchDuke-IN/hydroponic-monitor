    ...
    try {
        ...
        if (setRangesBtn) {
            setRangesBtn.addEventListener('click', () => {
                ...
                document.getElementById('moistureMin').value = CONFIG.sensors.soil_moisture.optimal[0];
                document.getElementById('moistureMax').value = CONFIG.sensors.soil_moisture.optimal[1];
                ...
                document.getElementById('rateMin').value = CONFIG.sensors.water_level.optimal[0];
                document.getElementById('rateMax').value = CONFIG.sensors.water_level.optimal[1];
